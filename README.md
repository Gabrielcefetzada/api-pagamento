...
Para fins de prova de conceito, posteriormente foi adicionado um JenkinsFile com o intuito de buildar a aplicação, rodar testes e fazer deploy no Render. A automação já foi desprovisionada tanto no Jenkins quanto no Render.
